...
const milestones = [
  ...
  { year: "June 2007", event: "Phantom Knights dissolved and merged with Survivors on the Guk server in EverQuest 2." },
  ...
  { year: "March 2014", event: "Pandamonium rebranded as an MMO Gaming Community and created a WildStar guild chapter." },
  ...
  { year: "May 2021", event: "Created pre-launch guild chapter in New World." },
  ...
  { year: "August 2023", event: "Created pre-launch community chapter in Palia." },
  ...
  { year: "April 2025", event: "Created pre-launch community chapter in Dune: Awakening." },
